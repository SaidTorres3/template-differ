...
// }
// editDocx()
var createTemplateEditor = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                labels = '';
                editableObjects.forEach(function (_a) {
                    var value = _a.value, paragraphIndex = _a.paragraphIndex, sentenseIndex = _a.sentenseIndex;
                    labels += "<span>".concat(value, "</span>");
                });
                textElement = dom.window.document.getElementById('text');
                textElement.innerHTML = labels;
                templateEditor = dom.serialize();
                (0, fs_1.writeFileSync)('src/templateEditor.html', templateEditor);
                return [2 /*return*/];
        }
    });
}); };
