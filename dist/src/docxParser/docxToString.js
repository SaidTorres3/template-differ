...
exports.docxToString = void 0;
var fs_1 = __importDefault(require("fs"));
var jszip_1 = __importDefault(require("jszip"));
var xml2js_1 = require("xml2js");
var docxToString = function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    file.async('string').then(function (XMLContent) {
                        (0, xml2js_1.parseString)(XMLContent, function (err, result) {
                            ...
                            paragraphs.forEach(function (paragraph) {
                                var textInTheParagraph = '';
                                var saveTheParagraph = function () {
                                    textInTheParagraph += '\r\n';
                                    docxInTxt += textInTheParagraph;
                                };
                                var WRLabel = paragraph['w:r'];
                                if (!WRLabel || !WRLabel.length) {
                                    saveTheParagraph();
                                    return;
                                }
                                WRLabel.forEach(function (WR) {
                                    var text = '';
                                    var WTLabel = WR['w:t'];
...
exports.docxToString = docxToString;
